...
int main() {
    ...
    Student students[STUDENT_COUNT] = {
        {"zhang", 1001, "南京", "编程", "汉族", "基督教", false},
        {"wang", 1003, "西安", "美术", "回族", "伊斯兰教", false},
        {"zhao", 1004, "杭州", "写作", "汉族", "基督教", false},
        {"zhou", 1005, "青岛", "游戏", "汉族", "佛教", false},
        {"wu", 1006, "苏州", "舞蹈", "回族", "伊斯兰教", false},
        {"chen", 1007, "沈阳", "历史", "汉族", "基督教", true},
        {"sun", 1008, "大连", "化学", "汉族", "佛教", true},
        {"ming", 1009, "北京", "篮球", "汉族", "佛教",false},
        {"qian", 1010, "重庆", "阅读", "汉族", "佛教",true},
        {"zheng", 1011, "西安", "美术", "回族", "伊斯兰教",false},
        {"geng", 1012, "杭州", "写作", "汉族", "基督教",true},
        {"qing", 1013, "青岛", "游戏", "汉族", "佛教",false},
        {"peng", 1014, "苏州", "舞蹈", "回族", "伊斯兰教",false},
        {"cheng", 1015, "沈阳", "历史", "汉族", "基督教",false},
        {"dong", 1016, "大连", "化学", "汉族", "佛教",false},
        // 其他学生信息...
        };
...
// main2
// int main() {
//     readStudent students[100];
//     int studentCount = readStudentsFromFile(students, "student.txt");
